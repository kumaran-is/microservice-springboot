...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.apis(RequestHandlerSelectors.basePackage("com.employee")).paths(PathSelectors.any()).build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {

		return new ApiInfoBuilder().title("Employee Management API Swagger Documentation")
				.description("This API can be used to add, update, delete and fetch employee from library")
