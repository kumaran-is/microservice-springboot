...
public class LoggingAspect {
   ...
   @Before(value = "execution(* com.employee.controller.*.*(..))")
	...
	/*@Before(value = "execution(* com.employee.controller.*.*(..)) and args(object)")
	 ...
	 * @param result
	 */
	@AfterReturning(value = "execution(* com.employee.controller.*.*(..))", returning = "returningObject")
	...
	@AfterThrowing(pointcut = "execution(* com.employee.controller.*.*(..))", throwing = "error")
