...
public class LoggingAspect {
   ...
   @Before(value = "execution(* com.department.controller.*.*(..))")
	...
	/*@Before(value = "execution(* com.department.controller.*.*(..)) and args(object)")
	...
	@After(value = "execution(* com.department.controller.*.*(..))")
	 ...
	 * @param result
	 */
	@AfterReturning(value = "execution(* com.department.controller.*.*(..))", returning = "returningObject")
	 ...
	 * @throws Throwable
	 */
 	@Around(value = "execution(* com.department.controller.*.*(..))")
	...
	@AfterThrowing(pointcut = "execution(* com.department.controller.*.*(..))", throwing = "error")
