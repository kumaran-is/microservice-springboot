...
public class SwaggerConfig {
	...
	public Docket api() {
		return new Docket(DocumentationType.SWAGGER_2).select()
				...
				.apis(RequestHandlerSelectors.basePackage("com.department")).paths(PathSelectors.any()).build()
				.apiInfo(apiInfo());
	}

	private ApiInfo apiInfo() {

		return new ApiInfoBuilder().title("Department API Microservice Swagger Documentation")
				...
				.contact(new Contact("Department API", "https://github.com/kumaran-is", "kumaran.isk@gmail.com")).build();
	}
